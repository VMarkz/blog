...
var i_28445 = (0);
while(true){
if((i_28445 < arr.length)){
(arr[i_28445] = null);

var G__28446 = (i_28445 + (1));
i_28445 = G__28446;
continue;
} else {
}
...
var i_28455 = (self__.level + (1));
while(true){
if((i_28455 <= (new_level + (1)))){
(update[i_28455] = self__.header);

var G__28456 = (i_28455 + (1));
i_28455 = G__28456;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_28457 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28457[i]));
} else {
x__$2.forward.push((((i < links_28457.length))?(links_28457[i]):null));
}

if((i < links_28457.length)){
(links_28457[i] = x__$2);
} else {
links_28457.push(x__$2);
}
...
var i_28459 = (0);
while(true){
if((i_28459 <= self__.level)){
var links_28460 = (update[i_28459]).forward;
if((x__$1 === (((i_28459 < links_28460.length))?(links_28460[i_28459]):null))){
(links_28460[i_28459] = (x__$1.forward[i_28459]));

var G__28461 = (i_28459 + (1));
i_28459 = G__28461;
continue;
} else {
var G__28462 = (i_28459 + (1));
i_28459 = G__28462;
continue;
}
} else {
...
var G__28464 = nx;
var G__28465 = (level__$1 - (1));
x = G__28464;
level__$1 = G__28465;
continue;
} else {
var G__28466 = x;
var G__28467 = (level__$1 - (1));
x = G__28466;
level__$1 = G__28467;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__28470 = nx;
var G__28471 = (level__$1 - (1));
x = G__28470;
level__$1 = G__28471;
continue;
} else {
var G__28472 = x;
var G__28473 = (level__$1 - (1));
x = G__28472;
level__$1 = G__28473;
continue;
}
